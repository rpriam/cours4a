...
- <code style="color : cyan">Projets </code> <br>
    ...
    - références+ [pandas](https://pandas.pydata.org/docs/user_guide/indexing.html) [sklearn](https://scikit-learn.org/stable/auto_examples/index.html) [graphiques](https://python-graph-gallery.com/) [seaborn](https://seaborn.pydata.org/examples/index.html) [fanalysis](https://github.com/OlivierGarciaDev/fanalysis/blob/master/doc/pca_tutorial.pdf)
